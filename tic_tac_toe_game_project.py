...
Original file is located at
    https://colab.research.google.com/drive/1Y-znA5ACOSbJOmvVzCZVR9oePEEXBnGB
"""

#Tic-Tac-Toe game.
''' The game is based on board in which contains 9 empty spaces formed by drawing the intersection of two horizontal lines and two vertical lines. By preparing a dictionary in which keys will be the location(i.e : top-left,mid-right,etc.) and initialliy it's values will be empty space and then after every move we will change the value according to player's choice of move.'''
